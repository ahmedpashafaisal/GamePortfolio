...
2. Clone the forked repo from your account using:
   ...
   ```bash
     git clone https://github.com/ahmedpashafaisal/home.git
   ```
...
6. Change URL in [package.json](./package.json) file:
   ...
   ```json
     "homepage": "https://ahmedpashafaisal.github.io"
   ```
...
8. Now you need to go to [pages.js](../pages.js#L3)
   ...
   ```js
   const repoURL =
     "https://github.com/ahmedpashafaisal/ahmedpashafaisal.github.io.git";
   ```
